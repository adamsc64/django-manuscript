...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Title.slug'
        db.add_column('wyclif_title', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=70, unique=True, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Title.slug'
        db.delete_column('wyclif_title', 'slug')
    ...
    models = {
        ...
        'wyclif.title': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '70', 'unique': 'True', 'null': 'True', 'db_index': 'True'}),
