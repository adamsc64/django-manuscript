...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chapter.slug'
        db.add_column('wyclif_chapter', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=70, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chapter.slug'
        db.delete_column('wyclif_chapter', 'slug')
