...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Title.publication_year'
        db.alter_column('manuscript_title', 'publication_year', self.gf('django.db.models.fields.CharField')(max_length=15))


    def backwards(self, orm):
        
        # Changing field 'Title.publication_year'
        db.alter_column('manuscript_title', 'publication_year', self.gf('django.db.models.fields.IntegerField')())
