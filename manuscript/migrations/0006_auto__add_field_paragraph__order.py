...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('manuscript_paragraph', '_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Paragraph._order'
        db.delete_column('manuscript_paragraph', '_order')
