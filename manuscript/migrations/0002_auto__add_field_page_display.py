...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('manuscript_page', 'display', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.display'
        db.delete_column('manuscript_page', 'display')
