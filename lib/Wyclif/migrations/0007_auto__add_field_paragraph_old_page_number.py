...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Paragraph.old_page_number'
        db.add_column('Wyclif_paragraph', 'old_page_number', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Paragraph.old_page_number'
        db.delete_column('Wyclif_paragraph', 'old_page_number')
