...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Page', fields ['number']
        db.delete_unique('Wyclif_page', ['number'])

        # Adding unique constraint on 'Page', fields ['number', 'title']
        db.create_unique('Wyclif_page', ['number', 'title_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Page', fields ['number', 'title']
        db.delete_unique('Wyclif_page', ['number', 'title_id'])

        # Adding unique constraint on 'Page', fields ['number']
        db.create_unique('Wyclif_page', ['number'])
